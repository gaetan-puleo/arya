...
const ENTRY = resolve(ROOT, 'packages/arya/src/index.ts');
const DIST = resolve(ROOT, 'dist');
const BUNDLE = resolve(DIST, 'arya.bundle.js');

const TARGETS = [
  { target: 'x86_64-unknown-linux-gnu', out: 'arya-linux-x64' },
  { target: 'aarch64-unknown-linux-gnu', out: 'arya-linux-arm64' },
  { target: 'x86_64-apple-darwin', out: 'arya-macos-x64' },
  { target: 'aarch64-apple-darwin', out: 'arya-macos-arm64' },
  { target: 'x86_64-pc-windows-msvc', out: 'arya-windows-x64.exe' },
];
...
console.log('Bundling arya into a single self-contained module…');
